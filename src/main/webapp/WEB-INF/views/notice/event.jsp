                      ...
                      <tr>
                       ...
                       <c:forEach items="${map.list }" var="bean"> 
                         ...
                         <tr>
                            ...
                            <td><a class="detailList" href="event/detail?idx=${bean.event_seq }">${bean.event_seq }</a></td>
                            <td><a class="detailList" href="event/detail?idx=${bean.event_seq }">${bean.event_title }</a></td>
                            <td><a class="detailList" href="event/detail?idx=${bean.event_seq }">${bean.event_writer_id }</a></td>
                            <td><a class="detailList" href="event/detail?idx=${bean.event_seq }">${bean.regi_date }</a></td>
                            <td><a class="detailList" href="event/detail?idx=${bean.event_seq }">${bean.event_hits }</a></td>
                         </tr>
                      </c:forEach>
...
<div id="eventadd">   <!-- 글쓰기 페이지 -->
      ...
      <div>
         ...
         <div>
            <textarea class="form-control" name="event_content" placeholder="내용을 입력해주세요" rows="20"></textarea>
         </div>
