...
<body>
	...
	<!-- 첨부파일 끝 -->
				...
				<div>
					...
					<div>
						<input type="text" name="sub" class="form-control" value="${eventdetail.event_title }" >
					</div>
					<div>
						<textarea class="form-control" name="content"  rows="20" >${eventdetail.event_content }
